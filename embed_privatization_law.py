...
def main():
    ...
    print("Creating embeddings for privatization law amendment...")
    ...
    processed_file = embeddings_dir / "060325-zakon-o-izmeni-zakona-o-privatizaciji.jsonl"
    
    if processed_file.exists():
        print("Creating collection and upserting data...")
        
        # Create collection
        collection_name = "060325_zakon_o_izmeni_zakona_o_privatizaciji"
        ...
        print(f"Successfully embedded {len(points)} articles from privatization law amendment!")
    else:
